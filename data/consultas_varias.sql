...
--Select * from SIGKILL.profesional
...
Select DISTINCT Consulta_Sintomas,Consulta_Enfermedades from gd_esquema.Maestra Where Consulta_Sintomas is not null 